...
offerings$callout <- as.factor(offerings$callout)
offerings$smsin <- as.factor(offerings$smsin)
offerings$smsout <- as.factor(offerings$smsout)
offerings$internet <- as.factor(offerings$internet)
...
centroid_reg <- function(data){
  distances = read_delim(data, delim = ",",col_names = TRUE ) 
  ...
  internet_dist <-  lm(closeness ~ c1+c2+c3, data = distances)
  print(summary(internet_dist))
#   print(summary( lm(closeness ~ c1, data = distances)))
#   print(summary( lm(closeness ~ c2, data = distances)))
#   print(summary( lm(closeness ~ c3, data = distances)))
  print ("Beta")
  print (internet_dist$coeff["c1"] * sd(distances$c1) / sd(distances$closeness))
  print (internet_dist$coeff["c2"] * sd(distances$c2) / sd(distances$closeness))
  print (internet_dist$coeff["c3"] * sd(distances$c3) / sd(distances$closeness))
  
  internet_dist <-  lm(betweenness ~ c1+c2+c3, data = distances)
  print(summary(internet_dist))
#   print(summary( lm(betweenness ~ c1, data = distances)))
#   print(summary( lm(betweenness ~ c2, data = distances)))
#   print(summary( lm(betweenness ~ c3, data = distances)))
  
  print ("Beta")
  print (internet_dist$coeff["c1"] * sd(distances$c1) / sd(distances$betweenness))
  print (internet_dist$coeff["c2"] * sd(distances$c2) / sd(distances$betweenness))
  print (internet_dist$coeff["c3"] * sd(distances$c3) / sd(distances$betweenness))
...
```{r}
setwd("/Users/myeong/git/DSSG/DSSG2016-SensingTheCensus/")
centroid_reg("data/CDR/generated/adjusted_internet_dist.csv")
centroid_reg("data/CDR/generated/adjusted_callIn_dist.csv")
centroid_reg("data/CDR/generated/adjusted_callOut_dist.csv")
centroid_reg("data/CDR/generated/adjusted_smsIn_dist.csv")
centroid_reg("data/CDR/generated/adjusted_smsOut_dist.csv")
```

```{r}
setwd("/Users/myeong/git/DSSG/DSSG2016-SensingTheCensus/")
deprivation_func <- function(data){
  distances = read_delim(data, delim = ",",col_names = TRUE ) 
  ...
  distances <-  distances %>% left_join(census@data, by = c("region"="ACE"))
  print(summary(lm(deprivation ~ c1+c2+c3, data = distances)))
}

deprivation_func("data/CDR/generated/adjusted_callin_dist.csv")
deprivation_func("data/CDR/generated/adjusted_callOut_dist.csv")
deprivation_func("data/CDR/generated/adjusted_internet_dist.csv")
deprivation_func("data/CDR/generated/adjusted_smsOut_dist.csv")
deprivation_func("data/CDR/generated/adjusted_smsIn_dist.csv")
```
