...
census = readOGR("data/census/mexico_city/IMU_2010.shp", layer="IMU_2010")
...
streets_cdmx = readOGR("data/geography/mexico_city/streets/carreviali09/Red_de_Carreteras_09_DF.shp",
                       layer = "Red_de_Carreteras_09_DF")

streets_edomex = readOGR("data/geography/mexico_city/streets/carreviali15/Red_de_Carreteras_15_Mex.shp",
...
writeLinesShape(streets,"data/geography/mexico_city/streets/mexico_city_streets.shp")


#' Plot deprivation index
